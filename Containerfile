...
# `oid4vp-core-0.2.0-SNAPSHOT-tests.jar`, which is the simulated wallet and its deliberate cheat
# modes, into a production image.
COPY oid4vp-core/target/oid4vp-core-0.2.0-SNAPSHOT.jar   /opt/keycloak/providers/
COPY oid4vp-login/target/oid4vp-login-0.2.0-SNAPSHOT.jar /opt/keycloak/providers/
...
COPY account-console/oid4vp-account/target/oid4vp-account-ui-0.2.0-SNAPSHOT.jar /opt/keycloak/providers/
...
COPY admin-console/oid4vp-admin/target/oid4vp-admin-ui-0.2.0-SNAPSHOT.jar /opt/keycloak/providers/
